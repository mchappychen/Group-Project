...
data2 <- corgis %>%
  ...
  transmute(
    ...
    test_takers = total,
    "400-600" = `200-300 Math` + `200-300 Verbal`,
    "600-800" = `300-400 Math` + `300-400 Verbal`,
    "800-1000" = `400-500 Math` + `400-500 Verbal`,
    "1000-1200" = `500-600 Math` + `500-600 Verbal`,
    "1200-1400" = `600-700 Math` + `600-700 Verbal`,
    "1400-1600" = `700-800 Math` + `700-800 Verbal`,
    )
data2
```
